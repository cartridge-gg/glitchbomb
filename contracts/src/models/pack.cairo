...
pub impl PackAssert of AssertTrait {
    #[inline]
    fn assert_not_open(self: @Pack) {
        assert(self.game_count == @0, ERRORS::PACK_ALREADY_OPEN);
    }

    #[inline]
    fn assert_is_open(self: @Pack) {
        assert(self.game_count != @0, ERRORS::PACK_NOT_OPEN);
    }
