      ...
      <div className="flex-1 flex flex-col items-center px-4 pb-0 min-h-0 overflow-hidden">
        <div className="flex flex-col gap-4 w-full max-w-[500px] min-h-0 flex-1 md:flex-initial">
          ...
          <GradientBorder color="purple" className="rounded-xl">
            <button
              type="button"
              className="relative w-full rounded-xl px-4 flex items-center justify-between overflow-hidden"
              style={{
                background:
            ...
            >
              ...
              >
                ...
                <defs>
                  ...
                  >
                    ...
                    <stop offset="1" stopColor="#8581FF" stopOpacity="0" />
                  </linearGradient>
                  <linearGradient
                    id="pb1"
                    x1="90.669"
              ...
              <div className="relative flex items-center gap-3">
                <NumsLogoIcon size="xl" className="text-white" />
              ...
              <div
                className="relative text-2xl uppercase px-5 rounded-lg tracking-wide"
                style={{
                  fontFamily: "'Pixel Game', sans-serif",
