...
export const Games = () => {
  ...
  return (
    <div className="absolute inset-0 flex flex-col">
      {/* GlitchBomb logo - same position as home page */}
      <GlitchBombIcon
        size="xl"
        className="absolute top-9 left-1/2 -translate-x-1/2 text-white z-10"
      />

      {/* Header - full width */}
      <div className="flex items-center justify-between px-4 pt-24 pb-4">
        {/* Left: Back button */}
        <Button
          variant="secondary"
